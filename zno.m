...
archivos = dir(fullfile(carpeta, '*ZCe4.txt'));
...
figure; hold on;
%title('Espectros Raman para el ZnO'); 
...
for i = 1:length(archivos)
    ...
    plot(desplazamientoRaman, intensidad, 'k', 'LineWidth', 1.5, 'DisplayName', archivos(i).name);
end
