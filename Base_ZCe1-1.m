...
if ~exist('ZCe1.txt', 'file') % Comprueba si el archivo existe en la carpeta
    error('El archivo ZCe1.txt no se encuentra en la carpeta especificada.');
    % Muestra error si no existe
end
%==============================================================================
% Cargar datos del espectro Raman
data = load('ZCe1.txt'); % Carga los datos del archivo como matriz numérica
...
%-=======================================================================
figure;
plot(raman_shift, intensity, 'k', 'DisplayName','ZCe1.txt'); hold on; 
...
%title('Corrección de Línea Base - espectro Raman ZCe1'); % Título de la gráfica
