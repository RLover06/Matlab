%% Logaritmos
function ajustePseudoVoigt_ZnO()
    ...
    y_raw = data(:,2);  % Eje Y original: intensidad del espectro

    % Aplicar logaritmo natural a la intensidad (evitando log(0))
    y = log(y_raw + eps);  % Intensidad transformada logarítmicamente
    ...
    modeCentersAll = [99, 128, 269, 403, 380, 410, 440, ...
                      561, 574, 590, 618, 348, ...
    ...
    ylabel('ln(Intensidad) (u.a.)');  % Etiqueta modificada para log
