function ajustePseudoVoigt_LnZCe3()
    ...
    y_raw = data(:,2);  % Extraer eje Y original (intensidad)

    % Aplicar logaritmo natural a la intensidad
    y = log(y_raw + eps);  % Intensidad transformada con logaritmo natural
    ...
    modeCentersAll = [102, 131.3, 270, 404, 380, 412.2, 440, ...
                      562.8, 574.9, 590, 620, 350, ...
                      537.7, 983.6, 1111.5, 334, 284, 207, 813];
