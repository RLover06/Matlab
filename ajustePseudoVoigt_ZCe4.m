function ajustePseudoVoigt_ZCe4()
    ...
    FWHM_teorico = [1.5, NaN, NaN, NaN, NaN, NaN, 6.5, NaN, NaN, 19, ...
                    18, 20, 10, 15, 12, 25, 50, 12, 20, 20, 50]';
    ...
    title('Ajuste de espectro Raman de ZCe4 con perfiles Pseudo-Voigt');
