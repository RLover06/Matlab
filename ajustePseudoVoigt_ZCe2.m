function ajustePseudoVoigt_ZCe2()
    ...
    modeCentersAll = [102, 132, 272, 405, 381, 412.8, 441, ...
                      563.2, 574.9, 591, 622.1, 351, ...
                      538.4, 984.2, 1112.1, 334.5, 284.4, 207.3, 814.3, 467.2];

    % FWHM teóricos para comparación (en cm^-1), si no hay datos teoricos
    % reportados se designan como NaN, si se conocen bajo el mismo ajuste,
    % simplemente reportalo para poder comparlo 
    ...
    %title('Ajuste de espectro Raman de ZCe2 con perfiles Pseudo-Voigt');
    xlabel('Desplazamiento Raman (cm^{-1})');
    ylabel('Intensidad (u.a.)');

    % Graficar espectro experimental y ajuste
    h_exp = plot(x, y, 'k', 'LineWidth', 1.5, 'DisplayName', 'ZCe4');
